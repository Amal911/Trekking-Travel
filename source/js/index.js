...
sr.reveal('.about-img3',{origin:'left',duration: 300, distance: '300px', delay:600, easing:'linear'})
sr.reveal('.about-img4',{origin:'top',duration: 300, distance: '300px', delay:700, easing:'linear'})
sr.reveal('.about-img5',{origin:'bottom',duration: 300, distance: '300px', delay:900, easing:'linear'})
sr.reveal('.about-img6',{origin:'right',duration: 300, distance: '300px', delay:800, easing:'linear'})
sr.reveal('.tag, .heading, .para, .ex-btn',{origin:'right', interval:200,delay:0})
